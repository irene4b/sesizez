...
const pistaBicicleteNesigura = {
  ...
  generator: (personal: userPersonalData, location: reportedLocation) => {
    ...
    return (
      ...
      `În prezent oricine circulă cu bicicleta sau trotineta electrică pe această pistă de biciclete este pus în pericol de autovehiculele ce circulă cu mare viteză pe benzile de lângă și cele ce opresc neregulamentar pe pistă. Situația curentă se poate vedea și în pozele atașate.\n\n` +
      `Dorim separarea acestor piste de biciclete și aducerea lor la un standard decent pentru a putea circula în siguranță și cu bicicleta pe stradă:\n\n` +
