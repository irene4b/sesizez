import { ADMINISTRATIA_STRAZILOR } from './administratiaStrazilor';
import { ADP } from './adp';
import { ANPM } from './anpm';
import { BRIGADA_RUTIERA } from './brigadaRutiera';
import { POLITIA_LOCALA } from './politiaLocala';
import { PRIMARIE } from './primarie';
import { TRANSPORT_DE_SUPRAFATA } from './transportDeSuprafata';
...
export const authoritiesEmails = {
  ...
  primarie: PRIMARIE,
  transportDeSuprafata: TRANSPORT_DE_SUPRAFATA,
};
